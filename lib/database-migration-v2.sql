-- ====================================================================
-- DIMDIM V2.0 - SCRIPT DE MIGRAÇÃO SEGURO
-- Migração da v1.0 para v2.0 com suporte a categorias e orçamentos
-- ====================================================================

-- ====================================================================
-- BACKUP E VERIFICAÇÕES INICIAIS
-- ====================================================================
...
BEGIN
    IF NOT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'transactions') THEN
        RAISE EXCEPTION 'Tabela transactions não existe. Execute primeiro o script database.sql';
    END IF;
END $$;
...
-- ====================================================================
-- ADICIONAR COLUNA CATEGORY_ID À TABELA TRANSACTIONS EXISTENTE
-- ====================================================================
-- Verificar se a coluna category_id já existe antes de adicionar
DO $$
BEGIN
    IF NOT EXISTS (
...
-- ====================================================================
-- INSERIR CATEGORIAS PADRÃO (ANTES DOS ÍNDICES E VIEWS)
-- ====================================================================
...
-- ====================================================================
-- CONFIGURAR ROW LEVEL SECURITY PARA NOVAS TABELAS
-- ====================================================================
-- RLS para categories
...
-- ====================================================================
-- CRIAR TRIGGERS PARA UPDATED_AT (NOVAS TABELAS)
-- ====================================================================
...
-- ====================================================================
-- CRIAR VIEWS (APÓS TODAS AS TABELAS ESTAREM PRONTAS)
-- ====================================================================
...
-- Comentário para transactions atualizada
...
BEGIN
    ...
    IF table_count = 3 THEN
        RAISE NOTICE 'Migração concluída com sucesso! Todas as tabelas foram criadas/atualizadas.';
    ELSE
        RAISE EXCEPTION 'Erro na migração: algumas tabelas não foram criadas corretamente.';
    END IF;
END $$; 